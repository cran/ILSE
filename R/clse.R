...
ilse.numeric <- function(Y, X,bw=NULL, intercept=FALSE, k.type=NULL,K=NULL,bw.type='fix.bw',method="Par.cond", max.iter=50, peps=1e-5, feps = 1e-7,infor_output=FALSE, ...){
...
ilse.formula <- function(formula, data=NULL, bw=NULL,  intercept=FALSE, k.type=NULL,K=NULL,
                         bw.type='fix.bw', method="Par.cond", ...){
